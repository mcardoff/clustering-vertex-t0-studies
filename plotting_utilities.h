...
namespace MyUtl {
  ...
  struct AnalysisObj {
	...
	Form("./%s_ntrack.pdf",filenameIDer),
	score,
	...
	FOLD_TRACK, FOLD_TRACK+TRACK_WIDTH  );
      ...
      dataObjects["pu_frac"] = std::make_unique<PlotObj>(
        ...
        Form("./%s_pufrac.pdf",filenameIDer),
	score,
	...
	Form("./%s_nhstrack.pdf",filenameIDer),
	score,
	...
	Form("./%s_nputrack.pdf",filenameIDer),
	score,
